...
CHURN_Rank <- predict(xgb_churn_mod,m_test_xg) # Predict Churn
CHURN_P <- as.numeric(CHURN_Rank > 0.5) # Make Prediction Binary
val_table <- cbind(m_test,CHURN_P,CHURN_Rank) # Join to Table
...
cf_churn <- table(val_table$CHURN,val_table$CHURN_P)
